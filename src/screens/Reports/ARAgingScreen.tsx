// ============================================================
// FINMATRIX - AR Aging Screen
// ============================================================
// Table: Customer | Current | 1-30 | 31-60 | 61-90 | 90+ | Total
// Calculated from invoice due dates vs today. Totals row.
...
const buildAging = (): { rows: AgingRow[]; totals: Omit<AgingRow, 'customerId' | 'customerName'> } => {
  // Only non-cancelled, unpaid invoices (balance > 0)
  ...
  for (const inv of open) {
    const balance = r2(inv.total - inv.amountPaid);
    const daysOverdue = diffDays(inv.dueDate);
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        <View>
          ...
          <View style={styles.tableHeader}>
            <Text style={[styles.thCell, styles.nameCol]}>Customer</Text>
            {BUCKETS.map((b) => (
